...
# tf文件
TFRECORD_FILE = 'D:/python项目/work-gongdan/verification_code/tfrecord_data/train.tfrecords'
...
train_network_fn = nets_factory.get_network_fn(
    'alexnet_v2',
    num_classes=CHAR_SET_LEN * 4,  # 训练的结果的个数
    weight_decay=0.0005,
    is_training=True
)

with tf.Session() as sess:
    # [批次* 224* 224]==[批次* 224* 224 *1] 加个通道数
    ...
    for i in range(LOOP_TIMES):
        ...
        # saver.save(sess, 'D:/python项目/work-gongdan/verification_code/net结果保存/model2/crack_captcha.model', global_step=i)
